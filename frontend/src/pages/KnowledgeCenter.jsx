        ...
        <div className='bg-[#FCF9F4] text-black min-h-screen pt-10 pb-20 px-6 md:px-16 lg:px-24 font-serif'>
            ...
            <div className='max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12'>
                ...
                <div className='lg:col-span-4 space-y-8'>
                    ...
                    {/* POLL SECTION (MOVED HERE) */}
                    {poll && (
                        <div className='bg-gradient-to-br from-indigo-600 to-purple-700 rounded-[32px] p-8 text-white relative overflow-hidden'>
                            <div className='relative z-10'>
                                <h4 className='text-lg font-bold uppercase mb-2'>Community Poll</h4>
                                <p className='text-indigo-100 text-xs font-sans mb-6'>{poll.title}</p>
                                
                                <div className='bg-white/10 border border-white/20 rounded-2xl p-6 backdrop-blur-sm space-y-4'>
                                    <p className='text-sm font-bold mb-4'>{poll.question}</p>
                                            ...
                                            <div key={index}>
                                                {!hasVoted && !voting ? (
                                                    <button
                                                        ...
                                                        className={`w-full text-left p-3 rounded-xl border transition-all text-sm mb-2 ${
                                                            isSelected 
                                                    ...
                                                    >
                                                        <div className='flex items-center gap-2'>
                                                            <span className='font-bold w-5'>{String.fromCharCode(65 + index)}.</span>
                                                            <span>{option.text}</span>
                                                        </div>
                                                    </button>
                                                ) : (
                                                    <div className='flex flex-col gap-1 p-3 bg-white/20 rounded-xl text-sm mb-2'>
                                                        <div className='flex items-center justify-between'>
                                                            <div className='flex items-center gap-2'>
                                    ...
                                    {!hasVoted && !voting && selectedOption !== null && (
                                        <button
                                            ...
                                            className='w-full mt-4 py-3 bg-white text-black text-[10px] font-black uppercase rounded-xl hover:bg-gray-100 transition-all shadow-lg'
                                            disabled={voting}
                                        >
                                    ...
                                    {hasVoted && (
                                        <div className='text-center pt-4 mt-2 border-t border-white/20'>
                                            <p className='text-[10px] font-bold uppercase tracking-widest text-indigo-200'>Thank you for voting!</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                            <div className='absolute -right-10 -bottom-10 w-48 h-48 bg-white/10 blur-[60px] rotate-12'></div>
                        </div>
                    )}
