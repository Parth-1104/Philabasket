...
const FeaturedProducts = () => {
  ...
  return (
    <section className="bg-white py-8 md:py-12 overflow-hidden select-none relative border-t border-black/[0.03]">
      ...
      <div className="px-6 md:px-16 lg:px-10 relative z-10">
        {/* --- HEADER --- */}
        ...
        <div className="relative group/nav">
          ...
          <div
            ...
            className="flex overflow-x-auto gap-6 pb-10 pt-4 mobile-scrollbar snap-x snap-mandatory scroll-smooth -mx-6 md:-mx-16 lg:-mx-4 px-6 md:px-16 lg:px-4"
          >
            {featured.map((item) => (
              <div
                key={item._id}
              ...
              >
                ...
                <div className="h-full">
                  ...
                  >
                    ...
                    <div className="p-1 aspect-square md:aspect-[4/5] bg-[#fefeff]">
