...
const NewsletterBox = () => {
  ...
  return (
    <div className="bg-white py-5 px-6 relative overflow-hidden border-t border-black/[0.03]  lg:mt-[3vh]">
      <div className="mt-10 mb-5 flex flex-col items-center gap-4">
      ...
      <div className="relative z-10 text-center">
        ...
        <p className="text-[#DC5F00] max-w-lg mx-auto text-xs md:text-sm font-bold uppercase tracking-widest leading-relaxed mb-12">
          Receive priority intelligence on{" "}
          <span className="text-black">rare acquisitions</span> and private
          philatelic ledger updates.
        </p>

        <form
          onSubmit={onSubmitHandler}
          className="max-w-2xl mx-auto flex flex-col sm:flex-row items-stretch gap-0 shadow-2xl"
        >
          <input
