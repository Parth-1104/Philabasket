...
const Sidebar = () => {
  ...
  return (
    <div
      className={`relative flex flex-col min-h-screen bg-white border-r border-gray-100 transition-all duration-500 ${
    ...
    >
      ...
      <div className={`flex items-center gap-3 px-6 py-8 mb-4 ${collapsed ? 'justify-center px-0' : ''}`}>
        ...
        {!collapsed && (
          <div>
            <p className='text-[13px] font-black text-[#192D60] uppercase tracking-tighter'>
              PhilaBasket
            </p>
            <p className='text-[10px] font-bold text-[#BC002D] uppercase tracking-widest'>
              Registry
            </p>
          </div>
        )}
      ...
      <div className='p-6 mt-auto'>
        <button
          ...
          className='w-full h-12 rounded-2xl bg-gray-50 hover:bg-gray-900 hover:text-white flex items-center justify-center transition-all'
        >
