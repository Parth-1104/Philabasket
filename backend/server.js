...
app.use(cors({
    origin: ['https://philabasket-frontend.vercel.app', 'http://localhost:5173','http://localhost:5174','https://philabasket-admin.vercel.app','https://new.philabasket.in','https://admin.philabasket.in'],
    credentials: true
}))
